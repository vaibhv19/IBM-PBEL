...
This repository tracks the progress, milestones, certificates, and reference guidelines for the **IBM Collaborative Project-Based Experiential Learning (PBEL)** program, focusing on **Full Stack Web Development with JavaScript**.
...
*   **Exploratory Data Analysis (Mandatory Course)**
    ...
    *   *Verification documents are available under the [Certificate/](Certificate/) directory.*
