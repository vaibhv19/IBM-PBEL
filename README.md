...
```mermaid
graph TD
    A[Step 1: Sign Up on FSP Portal] --> B[Step 2: Apply for Government Incentive]
    B --> C[Step 3: Complete Mandatory EDA Course]
    C --> D[Step 4: Complete Course Assessment via DigiLocker]
    D --> E[Step 5: Project Submission under Mentor]
    E --> F[Step 6: Learner Ledger Activation by NASSCOM]
    F --> G[Step 7: Upload Verification & Bank Docs to CDAC]
    G --> H[Stipend Disbursed & IBM Certification Issued]
```
